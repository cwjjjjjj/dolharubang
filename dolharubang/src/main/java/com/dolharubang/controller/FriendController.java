...
public class FriendController {
    ...
    public ResponseEntity<List<FriendResDto>> getAcceptedFriendList(
    ...
    public ResponseEntity<List<FriendResDto>> getSentFriendRequests(
        @AuthenticationPrincipal PrincipalDetails principal) {
        Long memberId = principal.getMember().getMemberId();
    ...
    @PostMapping("/request")
    public ResponseEntity<FriendResDto> sendFriendRequest(
        @AuthenticationPrincipal PrincipalDetails principal,
